...
func CareerProfileData() CareerProfile {
	return CareerProfile{
		...
		Roles: []CareerRole{
			{
				...
				ArchiveHighlights: []CareerHighlight{
					...
					{Text: "Remain hands-on in Brave code and developer tooling, including browser work, the Go component-update service, and Brave Dev Loop, a Ralph Wiggum loop-inspired coding agent that implements stories, opens pull requests, responds to review, and manages CI loops."},
				},
			},
			{
		...
		Projects: []CareerProject{
			...
			{Name: "Brave Dev Loop", Description: "Ralph Wiggum loop-inspired coding agent for Brave projects that reads product requirements, implements user stories, runs tests, creates pull requests, handles review feedback, and manages CI in iterative loops.", URL: "https://github.com/brave-experiments/brave-dev-loop"},
